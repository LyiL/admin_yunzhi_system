...
import {AddRolegroupFunModel} from "../../../../common/model/system-manage/rolegoup-manage/add-rolegroup-fun.model";
 ...
 */
@Component({
    selector: 'add-rolegroup-funcpermission',
    templateUrl: 'add-rolegroup-funcpermission.component.html',
    providers: [RoleGroupManageService]
})
export class AddRolegroupFuncpermissionComponent  {

    public model: AddRolegroupFunModel = new AddRolegroupFunModel(); //form实列
    ...
    ngOnInit() {
        ...
        this.model.nodeIds=[];
        this.roleGroupManageService.loadGetAllFunc({roleId:this.paramas.rolecode,appId:this.paramas["appId"],parentRoleId:this.paramas["parentIds"],organNo:this.paramas["orgNo"]})
            .subscribe(res => {
    ...
    _submitForm(){
        ...
        this.roleGroupManageService.loadSaveRoleFunc(this.model).subscribe(res=>{
