 ...
 */
@Injectable()
export class RoleGroupManageService{
     ...
     * @type {string}
     */
    public  static ROLE_GROUP_MANAGE_LLIST_URL='/roleaction/findrolegroup';


    /**
     * 所属机构查询地址
     */
    public static BANKNO_URL = '/roleaction/getentityinfo';
